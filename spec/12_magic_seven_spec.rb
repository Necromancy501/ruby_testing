...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    ...
    subject(:magic){ described_class.new 2}

    context 'when the previous step is 5' do
      it 'returns 3' do
        previous_step = 5
        result = magic.subtract_random_number(5)
  ...
  describe '#play' do
    ...
    subject(:magic){ described_class.new 5}
    ...
    subject(:magic){ described_class.new 55}
    ...
    subject(:magic){ described_class.new 555}

    context 'when the random number is 555' do
      # remove the 'x' before running this test
      it 'will return 7' do
        result = magic.play
        expect(result).to equal 7
